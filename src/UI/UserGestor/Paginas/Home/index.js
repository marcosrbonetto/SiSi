...
class Home extends React.PureComponent {
      ...
      rowList: [
        {
          ...
          acciones: <React.Fragment>
            <Button onClick={this.onDialogoOpenImpresionReporte} size="small" color="secondary" className={props.classes.iconoAceptar}>
              <i class="material-icons">check</i>
            </Button>
            <Button onClick={this.onDialogoOpenCancelacion} size="small" color="secondary" className={props.classes.iconoEliminar}>
              <DeleteIcon />
            </Button>
          </React.Fragment>,
          data: {
        ...
        },
        {
          ...
          curso: 'Metalurgia',
          acciones: <React.Fragment>
            <Button onClick={this.onDialogoOpenConfirmacion} size="small" color="secondary" className={props.classes.iconoAceptar}>
              <i class="material-icons">check</i>
            </Button>
            <Button onClick={this.onDialogoOpenCancelacion} size="small" color="secondary" className={props.classes.iconoEliminar}>
              <DeleteIcon />
  ...
  onDialogoOpenConfirmacion = () => {
    this.setState({
      dialogoConfirmacion: true
    })
  }

  onDialogoCloseConfirmacion = () => {
    debugger;
    this.setState({
      dialogoConfirmacion: false
    })
  ...
  onDialogoOpenCancelacion = () => {
    this.setState({
      dialogoCancelacion: true
    })
  }

  onDialogoCloseCancelacion = () => {
    this.setState({
      dialogoCancelacion: false
    })
  }

  onDialogoOpenImpresionReporte = () => {
  ...
  onDialogoCloseImpresionReporte = () => {
    this.setState({
      dialogImpresionReporte: false,
      arrayReporte: []
    })
    ...
    return (
      <section className={classes.mainContainer}>
        ...
        <MiControledDialog
          ...
          onDialogoOpen={this.onDialogoOpenCancelacion}
          onDialogoClose={this.onDialogoCloseCancelacion}
          buttonOptions={{
        ...
        <MiControledDialog
          ...
          onDialogoClose={this.onDialogoCloseCancelacion}
          buttonOptions={{
            onDialogoAccept: this.onDialogoAcceptCancelacion,
            onDialogoCancel: this.onDialogoCancelCancelacion
          }}
        ...
        <MiControledDialog
          ...
          onDialogoOpen={this.onDialogoOpenImpresionReporte}
          onDialogoClose={this.onDialogoCloseImpresionReporte}
          titulo={'Imprimir'}
        >
          {/* imgPerfil: <Avatar src="https://servicios2.cordoba.gov.ar/cordobafiles/archivo/f_qdag0f9irgka9xj2l6mbll69gxmhlghezkmkj2mykg1pj0uuhwogqiqfic_c327l9gmyk9tutz1fuq0rc3_z2byq5gcg2j5tjpqcn6jid4x2rlv2nsaa2it7s64d7m2k4h7e_xegt2w8p79uvk4jj42a7uvrcfm1cn8jpq31o4raxvsv8ktwtsa_q6iqbxeop56c_zee/3" />,
          dniCuil: '20355266169',
